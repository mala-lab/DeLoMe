...
if __name__ == '__main__':
    ...
    parser.add_argument('--method', type=str, choices=["bare", 'lwf', 'gem', 'ewc', 'mas', 'twp', 'jointtrain', 'ergnn', 'DeLoMe','joint','Joint'], default="bare", help="baseline continual learning method")
    ...
    parser.add_argument('--DeLoMe_args', type=str2dict, default={'budget': [60], 'tro': [1.0]}, help='memory size and hyperparameter for imbalanced learning')
    ...
    parser.add_argument('--cls-balance', type=str, choices = ['logita', 'lossa', 'none'], default='logita', help='whether to balance the cls when training and testing')
    parser.add_argument('--balanced-acc', type=strtobool, default = True, help='whether to calculate the balanced performance when and testing')
    ...
    method_args = {'ergnn': args.ergnn_args, 'lwf': args.lwf_args, 'twp': args.twp_args, 'ewc': args.ewc_args,
                   'bare': args.bare_args, 'gem': args.gem_args, 'mas': args.mas_args, 'DeLoMe': args.DeLoMe_args,'joint': args.joint_args}
